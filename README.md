<img src="https://github.com/Supernova-Studio/exporter-pdf-assets/blob/main/readme-icon.png?raw=true" alt="Supernova Logo" style="max-width:100%;">
...
The PDF Asset exporter allows you to **export a list of images** in such a way that it can be immediately used in your production codebase. This specific exporter exports assets in generic fashion, as PDF format, without any additional formatting or generated support files. 
...
```
/icons/top-menu/burger.pdf
/icons/top-menu/user.pdf
```
...
In order to make the Supernova PDF Asset exporter available for your organization so you can start generating code from your design system, please follow the installation guide in our [developer documentation](https://developers.supernova.io/using-exporters/installing-exporters).
